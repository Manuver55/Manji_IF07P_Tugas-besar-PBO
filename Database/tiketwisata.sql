...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2021 at 11:19 AM
...
--
-- Dumping data for table `tbpengaturan`
--

INSERT INTO `tbpengaturan` (`username`, `Nama_Lengkap`, `Tanggal_Lahir`, `Jenis_Kelamin`, `Nomor_Telepon`) VALUES
('user', 'Nama Lengkap User', '2021-07-20', 'Laki-laki', '123456789123');
...
INSERT INTO `tbtiket` (`id_tiket`, `username`, `tanggal_tiket`, `jenis_tiket`, `lokasi_tiket`, `jumlah_tiket`, `jenis_pembayaran`, `total_harga`, `status_pembayaran`) VALUES
('MT001', 'c', '2021-07-17', 'Wisata Alam', 'Pantai Pandawa (Badung)', 3, 'Bank BRI', 90000, ''),
('MT007', 'c', '2021-07-31', 'Wisata Alam', 'Pantai Pandawa (Badung)', 7, 'Gopay', 210000, ''),
('MT008', 'a', '2021-07-31', 'Wisata Alam', 'Pantai Pandawa (Badung)', 3, 'Bank BRI', 90000, 'Sudah bayar'),
('MT009', 'a', '2021-07-31', 'Wisata Religi', 'Pura Besakih (Karangasem)', 3, 'Bank BCA', 120000, 'Sudah bayar'),
('MT010', 'a', '2021-07-30', 'Wisata Alam', 'Pantai Pandawa (Badung)', 3, 'Bank BRI', 90000, 'Sudah bayar'),
('MT011', 'a', '2021-07-31', 'Wisata Pendidikan', 'Bali Zoo Park (Gianyar)', 2, 'Bank BNI', 70000, 'Sudah bayar'),
('MT012', 'a', '2021-07-30', 'Wisata Religi', 'Pura Besakih (Karangasem)', 3, 'Bank BRI', 120000, 'Sudah bayar'),
('MT013', 'a', '2021-07-30', 'Wisata Religi', 'Pura Besakih (Karangasem)', 3, 'Bank BCA', 120000, 'Belum bayar');
